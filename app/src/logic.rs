...
pub trait Logic {
    type GetPageQuery: Serialize;
    type CreatePageQuery: Serialize;
    type Blocks: Serialize;

    fn build_get_page_query(&self) -> Result<Self::GetPageQuery, String>;
...
impl<Tz: TimeZone> Logic for AppLogic<Tz> {
    type GetPageQuery = serde_json::Value;
    type CreatePageQuery = serde_json::Value;
            ...
            "properties": {
                "Name": {
                    "title": [
                        {
                            "text": {
                                "content": "Generated by wakatime-notion-diary"
                            }
                        }
                    ]
                },
